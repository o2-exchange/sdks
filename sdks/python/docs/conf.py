...
# -- Path setup ---------------------------------------------------------------
# Add the SDK source to sys.path so autodoc can find it.
sys.path.insert(0, os.path.abspath("../src"))

# -- Project information ------------------------------------------------------

project = "O2 SDK for Python"
copyright = "2026, O2 Exchange"
author = "O2 Exchange"
release = "0.1.0"
version = "0.1"
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/o2-exchange/sdks",
            "html": (
...
linkcheck_ignore = [
    r"https://api\.testnet\.o2\.app.*",
    r"https://api\.devnet\.o2\.app.*",
    r"https://api\.o2\.app.*",
    r"wss://.*",
]
